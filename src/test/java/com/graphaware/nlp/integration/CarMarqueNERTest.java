...
public class CarMarqueNERTest extends StanfordNLPIntegrationTest {
    ...
    public void testCustomNER() {
        ...
        String q = "CALL ga.nlp.processor.train({textProcessor: \"com.graphaware.nlp.processor.stanford.StanfordTextProcessor\", modelIdentifier: \"test-ner\", alg: \"ner\", inputFile: 'car-marque-train.tsv', trainingParameters: {iter: 10}})";
